...
public class ButtonMenu extends BasicGameState {
	...
	public enum MenuState {
		...
		/** The "About" screen. */
		ABOUT(new Button[] { Button.ABOUT_WEBSITE, Button.ABOUT_REPOSITORY, Button.ABOUT_REPORT, Button.ABOUT_ENV,
				Button.ABOUT_CREDITS, Button.ABOUT_CLOSE }) {
			@Override
			public String[] getTitle(GameContainer container, StateBasedGame game) {
		 ...
		 * @param container the game container
		 * @param game      the game
		 * @param key       the key code that was pressed (see
		 *                  {@link org.newdawn.slick.Input})
	...
	private enum Button {
		...
		RESTART(t("Restart the game"), Color.orange) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
		...
		THROW(t("Throw an error!"), Color.blue) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				ErrorHandler.error(t("Congratulations! You've raised an error by yourself!"), null, true);
			}
		},
		CLEAR_SCORES(t("Clear local scores"), Color.magenta) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
		...
		FAVORITE_ADD(t("Add to Favorites"), Color.blue) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
				BeatmapSetNode node = ((ButtonMenu) game.getState(Opsu.STATE_BUTTONMENU)).getNode();
		...
		FAVORITE_REMOVE(t("Remove from Favorites"), Color.blue) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
				BeatmapSetNode node = ((ButtonMenu) game.getState(Opsu.STATE_BUTTONMENU)).getNode();
		...
		DELETE(t("Delete..."), Color.red) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
				BeatmapSetNode node = ((ButtonMenu) game.getState(Opsu.STATE_BUTTONMENU)).getNode();
				MenuState ms = (node.beatmapIndex == -1 || node.getBeatmapSet().size() == 1)
						? MenuState.BEATMAP_DELETE_CONFIRM
						: MenuState.BEATMAP_DELETE_SELECT;
		...
		DELETE_CONFIRM(t("Yes, delete this beatmap!"), Color.red) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
				BeatmapSetNode node = ((ButtonMenu) game.getState(Opsu.STATE_BUTTONMENU)).getNode();
				((SongMenu) game.getState(Opsu.STATE_SONGMENU)).doStateActionOnLoad(MenuState.BEATMAP_DELETE_CONFIRM,
						node);
				game.enterState(Opsu.STATE_SONGMENU, new EmptyTransition(), new FadeInTransition());
			}
		},
		DELETE_GROUP(t("Yes, delete all difficulties!"), Color.red) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				DELETE_CONFIRM.click(container, game);
			}
		},
		DELETE_SONG(t("Yes, but only this difficulty"), Color.red) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
				BeatmapSetNode node = ((ButtonMenu) game.getState(Opsu.STATE_BUTTONMENU)).getNode();
				((SongMenu) game.getState(Opsu.STATE_SONGMENU)).doStateActionOnLoad(MenuState.BEATMAP_DELETE_SELECT,
						node);
				game.enterState(Opsu.STATE_SONGMENU, new EmptyTransition(), new FadeInTransition());
			}
		},
		CANCEL_DELETE(t("Nooooo! I didn't mean to!"), Color.gray) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				CANCEL.click(container, game);
			}
		},
		RELOAD_CONFIRM(t("Let's do it!"), Color.green) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
		...
		RELOAD_CANCEL(t("Cancel"), Color.red) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				CANCEL.click(container, game);
			}
		},
		DELETE_SCORE(t("Delete score"), Color.green) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
		...
		CLOSE(t("Close"), Color.gray) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				CANCEL.click(container, game);
			}
		},
		RESET_MODS(t("Reset All Mods"), Color.red) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUCLICK);
				for (GameMod mod : GameMod.values()) {
		...
		ABOUT_WEBSITE(t("Visit Website"), Color.cyan) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
				try {
		...
		ABOUT_REPOSITORY(t("Browse Source Code"), Color.green) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
				try {
		...
		ABOUT_REPORT(t("Report an Issue"), Color.red) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
		...
		ABOUT_ENV(t("Copy Debug Info"), Color.orange) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
		...
		ABOUT_CREDITS(t("View Credits"), Color.magenta) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
				SoundController.playSound(SoundEffect.MENUHIT);
				try {
		...
		ABOUT_CLOSE(t("Close"), Color.gray) {
			@Override
			public void click(GameContainer container, StateBasedGame game) {
	 ...
	 */
	public void setMenuState(MenuState menuState, BeatmapSetNode node) {
		setMenuState(menuState, node, null);
	}
	 ...
	 */
	private BeatmapSetNode getNode() {
		return node;
	}
